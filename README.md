...
Para um Repositório bem sucedido (nota 10), analisei os critérios e dividi eles em tópicos por numeração, resultando em:
...
Estratégia Inicial: "O Cerco Coordenado": Como líder, minha estratégia inicial foca em Controle de Mapa e Pressão de Base: Início: Não dividimos o time excessivamente. Mantemos uma "Corrente de Pérolas" (tanques próximos que se apoiam) . Posicionamento: Enviamos a maior parte da força para a área de transição entre a cidade e as colinas. Isso permite flexibilidade para rotacionar caso o inimigo cometa o erro de isolar um tanque . Cap Lead: Capturar a Base B (Centro) cedo é crucial para forçar o inimigo a avançar de forma imprudente para interromper a pontuação, permitindo que joguemos defensivamente e usemos nossa blindagem .
...
Analisando diferente estratégias, usadas por diferentes times no mapa Rockfield, construa uma estratégia para este mapa. Monte uma LineUp com todos os tanques possíveis e mais plausíveis de acordo com o Meta. E calculando as porcentagens de vitória de acordo com cada estratégia, decida o melhor lado para jogar.
</td>
  </tr>
</table>
